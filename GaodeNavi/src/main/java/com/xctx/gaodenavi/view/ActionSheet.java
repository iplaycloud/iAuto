package com.xctx.gaodenavi.view;
...
public class ActionSheet {
	...
	public static Dialog showSheet(Context context,
		...
		TextView textSimulate = (TextView) layout
				.findViewById(R.id.textSimulate);
		TextView textReal = (TextView) layout.findViewById(R.id.textReal);
		TextView textCancel = (TextView) layout.findViewById(R.id.textCancel);
		
		textSimulate.setOnClickListener(new OnClickListener() {
		...
		textReal.setOnClickListener(new OnClickListener() {
