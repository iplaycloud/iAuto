...
import com.xctx.weather.view.SwitchAnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
	...
	private SwitchConfiguration mConf;
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setRadius(ta.getInt(R.styleable.SwitchButton_radius,
				SwitchConfiguration.Default.DEFAULT_RADIUS));
	...
	private void initView() {
		mConf = SwitchConfiguration.getDefault(getContext().getResources()
				.getDisplayMetrics().density);
		mTouchSlop = ViewConfiguration.get(getContext()).getScaledTouchSlop();
		mClickTimeout = ViewConfiguration.getPressedStateDuration()
				+ ViewConfiguration.getTapTimeout();
		mAnimationController = SwitchAnimationController.getDefault().init(
				mOnAnimateListener);
		mBounds = new Rect();
		if (SHOW_RECT) {
	...
	private Drawable fetchThumbDrawable(TypedArray ta) {
		...
		int normalColor = ta.getColor(R.styleable.SwitchButton_thumbColor,
				SwitchConfiguration.Default.DEFAULT_THUMB_COLOR);
		int pressedColor = ta.getColor(
				R.styleable.SwitchButton_thumbPressedColor,
				SwitchConfiguration.Default.DEFAULT_THUMB_PRESSED_COLOR);
	...
	public void setConfiguration(SwitchConfiguration conf) {
		if (mConf == null) {
			mConf = SwitchConfiguration.getDefault(conf.getDensity());
		}
