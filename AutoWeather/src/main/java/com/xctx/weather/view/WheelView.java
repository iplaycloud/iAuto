package com.xctx.weather.view;

import java.util.LinkedList;
import java.util.List;

import com.xctx.weather.R;
import com.xctx.weather.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Listeners
	private List<WheelOnWheelChangedListener> changingListeners = new LinkedList<WheelOnWheelChangedListener>();
	private List<WheelOnWheelScrollListener> scrollingListeners = new LinkedList<WheelOnWheelScrollListener>();
	private List<WheelOnWheelClickedListener> clickingListeners = new LinkedList<WheelOnWheelClickedListener>();
	 ...
	 */
	public void addChangingListener(WheelOnWheelChangedListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeChangingListener(WheelOnWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (WheelOnWheelChangedListener listener : changingListeners) {
	 ...
	 * @param listener the listener
	 */
	public void addScrollingListener(WheelOnWheelScrollListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeScrollingListener(WheelOnWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (WheelOnWheelScrollListener listener : scrollingListeners) {
	 ...
	 * @param listener the listener
	 */
	public void addClickingListener(WheelOnWheelClickedListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeClickingListener(WheelOnWheelClickedListener listener) {
	...
	protected void notifyClickListenersAboutClick(int item) {
		for (WheelOnWheelClickedListener listener : clickingListeners) {
	...
	public void invalidateWheel(boolean clearCaches) {
		if (clearCaches) {
			...
			// cache all items
			recycle.recycleItems(itemsLayout, firstItem, new WheelItemsRange());
		}
	 ...
	 */
	private WheelItemsRange getItemsRange() {
		if (getItemHeight() == 0) {
			return null;
		}
		...
		return new WheelItemsRange(first, count);
	}
	...
	private boolean rebuildItems() {
		...
		WheelItemsRange range = getItemsRange();
		if (itemsLayout != null) {
