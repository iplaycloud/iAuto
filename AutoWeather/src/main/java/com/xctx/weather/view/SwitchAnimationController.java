...
class SwitchAnimationController {
	 ...
	 * @return
	 */
	static SwitchAnimationController getDefault() {
		SwitchAnimationController ac = new SwitchAnimationController();
		return ac;
	}
	 ...
	 * 
	 * @param onAnimateListener
	 *            NOT NULL
	 * @return
	 */
	SwitchAnimationController init(OnAnimateListener onAnimateListener) {
	...
	interface OnAnimateListener {
		 ...
		 * 
		 * @param frame
		 *            next step of the animation, for linear animation, it is
		 *            equal to velocity
		 */
