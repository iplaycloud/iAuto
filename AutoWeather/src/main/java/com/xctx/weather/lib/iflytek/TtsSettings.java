package com.xctx.weather.lib.iflytek;
 ...
 * 合成设置界面
 */
public class TtsSettings extends PreferenceActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVolumePreference.getEditText().addTextChangedListener(
				new SettingTextWatcher(TtsSettings.this, mVolumePreference, 0,
						100));
