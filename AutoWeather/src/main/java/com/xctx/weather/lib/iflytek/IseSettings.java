...
public class IseSettings extends PreferenceActivity {
	...
	private void initUI() {
		...
		mLanguagePref
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						int newValueIndex = mLanguagePref
		...
		mCategoryPref
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						int newValueIndex = mCategoryPref
								.findIndexOfValue(newValue.toString());
				...
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						if ("zh_cn".equals(mLanguagePref.getValue())
								&& "plain".equals(newValue.toString())) {
		...
		mSpeechTimeoutPref.getEditText()
				.setInputType(
		...
		mSpeechTimeoutPref
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						int speech_timeout;
						try {
							speech_timeout = Integer.parseInt(newValue
									.toString());
						} catch (Exception e) {
							showTip("无效输入！");
							return false;
						...
						if (speech_timeout == -1) {
							...
							mSpeechTimeoutPref.setSummary("当前："
									+ speech_timeout + "ms");
						}
